...
export function toolIcon(name: string): string {
    const icons: Record<string, string> = {
        ...
        browser_agent_run: 'Browser Agent', browser_get_elements: 'Page Elements',
        browser_get_structure: 'Page Structure', browser_extract_table: 'Extract Table',
        browser_extract_links: 'Extract Links', browser_fill_form: 'Fill Form',
        browser_select: 'Select Option', browser_scroll: 'Scroll',
        browser_tab_open: 'Open Tab', browser_tab_switch: 'Switch Tab',
        browser_tab_list: 'List Tabs', browser_tab_close: 'Close Tab',
...
const groupLabels: Record<string, { single: string; plural: string }> = {
    ...
    browser_agent_run: { single: 'Browser Agent', plural: 'Browser Agent' },
    browser_get_elements: { single: 'Page Elements', plural: 'Page Elements' },
    browser_get_structure: { single: 'Page Structure', plural: 'Page Structure' },
    browser_extract_table: { single: 'Extract Table', plural: 'Extract Table' },
    browser_extract_links: { single: 'Extract Links', plural: 'Extract Links' },
    browser_fill_form: { single: 'Fill Form', plural: 'Fill Form' },
    browser_select: { single: 'Select Option', plural: 'Select Option' },
    browser_scroll: { single: 'Scroll', plural: 'Scroll' },
    browser_tab_open: { single: 'Open Tab', plural: 'Open Tab' },
    browser_tab_switch: { single: 'Switch Tab', plural: 'Switch Tab' },
    browser_tab_list: { single: 'List Tabs', plural: 'List Tabs' },
    browser_tab_close: { single: 'Close Tab', plural: 'Close Tab' },
    browser_status: { single: 'Browser Status', plural: 'Browser Status' },
    // Other
